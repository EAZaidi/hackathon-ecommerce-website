...
const WhyChooseUs = () => {
  return (
    <div className="bg-black text-white py-32 px-6 ">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-72 w-[80%]">
        {/* Image Grid Section */}
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="text-white text-5xl font-[Helvetica] font-bold mt-2">
          ...
          <div className="flex flex-cols-3 gap-8 mt-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-orange-500 mt-2">Fast Food</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-orange-500 mt-2">Lunch</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-orange-500 mt-2">Dinner</span>
            </div>
          </div>
