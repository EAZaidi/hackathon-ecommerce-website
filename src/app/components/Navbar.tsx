...
export default function Navbar() {
  return (
    <header className="w-full bg-black text-white">
      {/* Name of website */}
      <div className="text-2xl font-bold text-white flex items-center justify-center pt-4">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        <nav className="space-x-8">
          ...
          <a
            href="/menu"
            className="text-white hover:text-[#FF9F0D] outline-none"
          >
            Menu
          </a>
          <a
        ...
        <div className="flex items-center space-x-4 rounded-full">
          <div className="border border-[#FF9F0D] w-[310px] h-[54px] rounded-full outline-none flex">
            <input
              type="text"
              placeholder="Search..."
            ...
            />
        {/* Search Icon */}
            <button className="text-white flex items-center justify-end px-10">
