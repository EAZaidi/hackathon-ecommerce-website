        ...
        <div className="bg-white overflow-hidden">
          <table className="min-w-full">
            <thead className="bg-white">
              <tr>
                <th className="px-6 py-4 text-left text-[#333333] font-[18px]">
                  Product
                </th>
                <th className="px-6 py-4 text-center text-[#333333] font-[18px]">
                  Price
                </th>
                <th className="px-6 py-4 text-center text-[#333333] font-[18px]">
                  Quantity
            ...
            <tbody>
              {[
                ...
                <tr key={index} className="border-b">
                  ...
                  <td className="px-6 py-4 text-center text-[#333333] font-bold">
                    ${item.total.toFixed(2)}
                  </td>
                  <td className="px-6 py-4 text-center">
                    <button className="text-[#333333] hover:text-[#FF9F0D]">
                      X
                    </button>
                  </td>
                </tr>
        ...
        <div className="mt-10 p-6 flex flex-col lg:flex-row justify-between items-start lg:items-start gap-6 space-y-6 lg:space-y-0 text-[#333333]">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <button className=" flex items-center justify-center gap-2 mt-6 w-full h-[64px] px-4 py-2 bg-[#FF9F0D] text-white text-[18px] rounded hover:bg-orange-400">
              Proceed to Checkout
              <PiCheckSquareOffsetLight className="w-[20px] h-[20px]" />
            </button>
          </div>
        </div>
      </div>
